...
export default function VolumeRadar() {
  ...
  const fetchVolumeData = async () => {
    try {
      // Fetch trending data from our API proxy (avoids CORS issues)
      const response = await fetch('/api/volume-radar');
      ...
      const tokenDetails: TrendingToken[] = apiData.tokens;
      const totalVolume = apiData.totalVolume;
